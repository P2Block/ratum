...
pub(super) fn status_json(ctx: &Context, with_clients: bool) -> Value {
    ...
    json!({
        ...
        "stratum": {
            ...
            "network_hashps": server.network_hashps(),
            "network_share": crate::stratum::share_of_network(summary.hashrate_ths, server.network_hashps()),
            "max_network_share": cfg.max_network_share(),
        },
        "node_warnings": server.node_warnings(),
        "job": job,
        "coinbaser": coinbaser,
        "clients": clients,
